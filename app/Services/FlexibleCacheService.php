...
class FlexibleCacheService extends OptimizedSalesReportService
{
    public function dashboardReport(string $period = 'month'): array
    {
        ...
        return Cache::flexible($cacheKey, [300, 600], function () use ($period) {
            return parent::dashboardReport($period);
        });
    }
    ...
    public function getTopCustomersOptimized(string $period, int $limit = 3)
    {
        ...
        return Cache::flexible($cacheKey, [1800, 1800], function () use ($period, $limit) {
            return parent::getTopCustomersOptimized($period, $limit);
        });
    }
    ...
    public function getDailyBreakdownOptimized(string $period)
    {
        ...
        return Cache::flexible($cacheKey, [3600, 3600], function () use ($period) {
            return parent::getDailyBreakdownOptimized($period);
        });
    }
    ...
    public function getDatabaseSummary(string $period): array
    {
        ...
        return Cache::flexible($cacheKey, [300, 600], function () use ($period) {
            return parent::getDatabaseSummary($period);
        });
    }
    ...
    public function getAvgOrdersPerCustomer(string $period): float
    {
        ...
        return Cache::flexible($cacheKey, [300, 600], function () use ($period) {
            return parent::getAvgOrdersPerCustomer($period);
        });
    }
}
